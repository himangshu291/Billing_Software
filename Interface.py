...
from PIL import Image,ImageTk       #pip install pillowpip install pillow
import random,os
...
class Bill_App:
    def __init__(self,root):                                #constructor of Bill_App class
        ...
        img=img.resize((510,130), Image.ANTIALIAS)                  #Resize the image. ANTIALIAS is used to convert higher level image to lower level image
        ...
        Img=Img.resize((480,315),Image.ANTIALIAS)                  
        ...
        Img_1=Img_1.resize((470,315), Image.ANTIALIAS)                  
        ...
        #=================Generate Bill===================
        self.Btngenerate=Button(btn_Frame,command=self.gen_bill,height=2,text="Generate Bill",font=("times new roman",15,"bold"),bg="orangered",fg="white",width=15,cursor="hand2")
